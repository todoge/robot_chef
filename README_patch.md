...
- Rewrote the pour task pipeline to sequence perception, grasp refinement, pouring, and placement while producing overlay diagnostics and structured logging.
